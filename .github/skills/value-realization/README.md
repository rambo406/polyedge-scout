...
Works with GitHub Copilot Chat, Cursor, Cline, and other AI coding assistants.
...
2. Extract and copy to:
   - macOS/Linux: `~/.github/skills/value-realization`
   - Windows: `%USERPROFILE%\.github\skills\value-realization`
